...
# Base URL
REST_URLS = {
    "paradise_main": "https://api.paradise.exchange",
    "paradise_testnet": "https://api.testparadise.exchange"
}

WSS_URL = {
    "paradise_main": "wss://ws.paradise.exchange/ws/spot",
    "paradise_testnet": "wss://ws.testparadise.exchange/ws/spot"
}

WSS_URL_OB = {
    "paradise_main": "wss://ws.paradise.exchange/ws/oss/spot",
    "paradise_testnet": "wss://ws.testparadise.exchange/ws/oss/spot"
}
...
PARADISE_USER_STREAM_PATH_URL = "/ws/spot"
...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=SNAPSHOT_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
              linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT, 50),
                             LinkedLimitWeightPair(RAW_REQUESTS, 1)]),
    RateLimit(limit_id=PARADISE_USER_STREAM_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
