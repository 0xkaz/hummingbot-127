...
class ParadiseAuth(AuthBase):
    ...
    async def ws_authenticate(self, request: WSRequest) -> WSRequest:
        """
        This method is intended to configure a websocket request to be authenticated. Paradise does not use this
        functionality
        """
    ...
    def header_for_authentication(self, request: RESTRequest) -> Dict[str, str]:
        ...
        path = request.url.replace("https://api.paradise.exchange/spot", "").replace("https://api.testparadise.exchange/spot", "")
