...
from hummingbot.connector.exchange.paradise import paradise_constants as CONSTANTS, paradise_web_utils as web_utils
from hummingbot.connector.exchange.paradise.paradise_order_book import ParadiseOrderBook
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.paradise.paradise_exchange import ParadiseExchange


class ParadiseAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def _order_book_snapshot(self, trading_pair: str) -> OrderBookMessage:        
        ...
        snapshot_msg: OrderBookMessage = ParadiseOrderBook.snapshot_message_from_exchange(
            snapshot,
            snapshot_timestamp,
    ...
    async def _parse_trade_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):                    
        if 'data' in raw_message:
            for trade in raw_message["data"]:
                ...
                trade_message = ParadiseOrderBook.trade_message_from_exchange(
    ...
    async def _parse_order_book_diff_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):            
            ...
            order_book_message: OrderBookMessage = ParadiseOrderBook.diff_message_from_exchange(
