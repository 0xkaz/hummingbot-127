...
import hummingbot.connector.exchange.paradise.paradise_constants as CONSTANTS
import hummingbot.connector.exchange.paradise.paradise_web_utils as web_utils
...
class ParadiseAPIUserStreamDataSource(UserStreamTrackerDataSource):
