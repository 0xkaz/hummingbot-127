...
from hummingbot.connector.exchange.crypto_market import crypto_market_constants as CONSTANTS, crypto_market_web_utils as web_utils
from hummingbot.connector.exchange.crypto_market.crypto_market_order_book import CryptoMarketOrderBook
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.crypto_market.crypto_market_exchange import CryptoMarketExchange


class CryptoMarketAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    def __init__(self,
                 ...
                 connector: 'CryptoMarketExchange',
    ...
    def _rebase_snapshot_obj(self, snapshot: List[Dict[str, Any]]) -> Any:
        ...
        :param snapshot: The snapshot is the response from snaptshot api of crypto_market
    ...
    async def _order_book_snapshot(self, trading_pair: str) -> OrderBookMessage:        
        ...
        snapshot_msg: OrderBookMessage = CryptoMarketOrderBook.snapshot_message_from_exchange(
            snapshot,
            snapshot_timestamp,
    ...
    async def _parse_trade_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):                    
        if 'data' in raw_message:
            for trade in raw_message["data"]:
                ...
                trade_message = CryptoMarketOrderBook.trade_message_from_exchange(
    ...
    async def _parse_order_book_diff_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):            
            ...
            order_book_message: OrderBookMessage = CryptoMarketOrderBook.diff_message_from_exchange(
