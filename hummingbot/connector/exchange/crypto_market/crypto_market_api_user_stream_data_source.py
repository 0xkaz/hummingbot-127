...
import hummingbot.connector.exchange.crypto_market.crypto_market_constants as CONSTANTS
import hummingbot.connector.exchange.crypto_market.crypto_market_web_utils as web_utils
...
class CryptoMarketAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
                 auth: CryptoMarketAuth,                 
                 domain: str = CONSTANTS.DEFAULT_DOMAIN,
                 api_factory: Optional[WebAssistantsFactory] = None,
                 throttler: Optional[AsyncThrottler] = None,
                 time_synchronizer: Optional[TimeSynchronizer] = None):
        super().__init__()
        self._auth: CryptoMarketAuth = auth
