...
class CryptoMarketAuth(AuthBase):
    ...
    async def ws_authenticate(self, request: WSRequest) -> WSRequest:
        """
        This method is intended to configure a websocket request to be authenticated. CryptoMarket does not use this
        functionality
        """
    ...
    def header_for_authentication(self, request: RESTRequest) -> Dict[str, str]:
        ...
        path = request.url.replace("https://api.crypto-market.exchange/spot", "").replace("https://test-api.crypto-market.exchange/spot", "")
